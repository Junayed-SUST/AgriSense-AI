...
export const CROPS: CropRecord[] = [
  ...
  },
  {
    ...
    durationDays: 65,
    growthStages: [
      { name: 'Sowing', dayRange: [0, 5], keyActions: ['Seed treatment with Rhizobium', 'Line sowing 30cm apart'] },
      { name: 'Vegetative', dayRange: [10, 30], keyActions: ['Light weeding', 'Drain excess rainwater'] },
      { name: 'Flowering', dayRange: [30, 45], keyActions: ['Monitor pod borer and whitefly', 'Avoid waterlogging'] },
      { name: 'Pod filling', dayRange: [45, 60], keyActions: ['Harvest mature pods in batches'] },
      { name: 'Harvest', dayRange: [60, 65], keyActions: ['Dry pods well before threshing'] },
    ],
    waterNeedMm: 180,
    waterSourcePreference: ['rainfed', 'tubewell'],
    suitableSoils: ['loamy', 'silty', 'sandy'],
    rainfallTolerance: 'medium',
    fertilizerKgPerAcre: { npk15_15_15: 25, tsp: 28, mop: 18, boron: 0.8 },
    typicalYieldPerAcre: { min: 10, max: 16, unit: 'maund' },
    typicalPricePerUnit: { min: 4200, max: 6000, unit: 'maund', currency: 'BDT' },
    majorPests: ['Pod borer', 'Whitefly', 'Aphid'],
    majorDiseases: ['Yellow mosaic virus', 'Cercospora leaf spot', 'Powdery mildew'],
    riskLevel: 'medium',
    riskNotes: 'Short duration and low water need; heavy rain near flowering can reduce pod set.',
    notes: 'Fits well after Boro harvest and before Aman. BARI Mung-6 and BINA Mung varieties are common.',
    source: 'BARI Pulse Crop Manual (2022); BARC FRG 2018',
  },
  {
    id: 'sesame',
    ...
    durationDays: 90,
    growthStages: [
      { name: 'Sowing', dayRange: [0, 5], keyActions: ['Sow on raised, well-drained land', 'Thin seedlings after emergence'] },
      { name: 'Vegetative', dayRange: [10, 35], keyActions: ['Weed control', 'Light irrigation if dry'] },
      { name: 'Flowering', dayRange: [35, 60], keyActions: ['Avoid standing water', 'Monitor leaf roller'] },
      { name: 'Capsule formation', dayRange: [60, 80], keyActions: ['Keep field drained', 'Watch for phyllody'] },
      { name: 'Harvest', dayRange: [80, 90], keyActions: ['Harvest when lower capsules turn yellow'] },
    ],
    waterNeedMm: 250,
    waterSourcePreference: ['rainfed', 'tubewell'],
    suitableSoils: ['loamy', 'sandy', 'silty'],
    rainfallTolerance: 'medium',
    fertilizerKgPerAcre: { npk15_15_15: 35, urea: 25, tsp: 30, mop: 18, gypsum: 5 },
    typicalYieldPerAcre: { min: 8, max: 14, unit: 'maund' },
    typicalPricePerUnit: { min: 4200, max: 6500, unit: 'maund', currency: 'BDT' },
    majorPests: ['Leaf roller', 'Jassid', 'Aphid'],
    majorDiseases: ['Phyllody', 'Leaf spot', 'Stem rot'],
    riskLevel: 'medium',
    riskNotes: 'Good low-water oilseed option, but waterlogging and late heavy rain are major risks.',
    notes: 'Useful in coastal and char areas where low-input oilseed crops are preferred.',
    source: 'BARI Oilseed Cultivation Guide (2022); BARC FRG 2018',
  },
  {
    id: 'okra',
    ...
    durationDays: 100,
    growthStages: [
      { name: 'Sowing', dayRange: [0, 7], keyActions: ['Seed soaking', 'Line sowing 45x30cm'] },
      { name: 'Vegetative', dayRange: [15, 35], keyActions: ['Thinning', 'Weed control', 'First top dress'] },
      { name: 'Flowering', dayRange: [35, 55], keyActions: ['Monitor jassid and whitefly', 'Maintain moisture'] },
      { name: 'Harvest', dayRange: [45, 100], keyActions: ['Pick tender pods every 2-3 days'] },
    ],
    waterNeedMm: 350,
    waterSourcePreference: ['tubewell', 'rainfed', 'pond'],
    suitableSoils: ['loamy', 'silty', 'sandy'],
    rainfallTolerance: 'medium',
    fertilizerKgPerAcre: { npk15_15_15: 70, urea: 70, tsp: 45, mop: 35, gypsum: 8 },
    typicalYieldPerAcre: { min: 120, max: 200, unit: 'maund' },
    typicalPricePerUnit: { min: 600, max: 1300, unit: 'maund', currency: 'BDT' },
    majorPests: ['Jassid', 'Whitefly', 'Fruit borer'],
    majorDiseases: ['Yellow vein mosaic virus', 'Powdery mildew', 'Damping off'],
    riskLevel: 'medium',
    riskNotes: 'Frequent harvest gives cash flow, but whitefly-transmitted virus can reduce yield.',
    notes: 'Can be grown across warm seasons with good drainage and regular picking.',
    source: 'BARI Vegetable Cultivation Guide (2023); BARC FRG 2018',
  },
  {
    id: 'cucumber',
    ...
    durationDays: 75,
    growthStages: [
      { name: 'Sowing', dayRange: [0, 7], keyActions: ['Prepare raised beds', 'Sow treated seeds'] },
      { name: 'Vine growth', dayRange: [10, 30], keyActions: ['Install support if needed', 'Weed control'] },
      { name: 'Flowering', dayRange: [30, 45], keyActions: ['Maintain pollination', 'Irrigate lightly'] },
      { name: 'Harvest', dayRange: [45, 75], keyActions: ['Harvest fruits every 2-3 days'] },
    ],
    waterNeedMm: 320,
    waterSourcePreference: ['tubewell', 'pond', 'canal'],
    suitableSoils: ['loamy', 'sandy', 'silty'],
    rainfallTolerance: 'medium',
    fertilizerKgPerAcre: { npk15_15_15: 80, urea: 75, tsp: 55, mop: 45, gypsum: 8, boron: 1 },
    typicalYieldPerAcre: { min: 180, max: 280, unit: 'maund' },
    typicalPricePerUnit: { min: 450, max: 1100, unit: 'maund', currency: 'BDT' },
    majorPests: ['Fruit fly', 'Red pumpkin beetle', 'Aphid'],
    majorDiseases: ['Downy mildew', 'Powdery mildew', 'Mosaic virus'],
    riskLevel: 'medium',
    riskNotes: 'High market demand but fruit fly and heavy rain can reduce marketable yield.',
    notes: 'Short duration vegetable crop suitable for raised beds and quick cash return.',
    source: 'BARI Vegetable Cultivation Guide (2023); BARC FRG 2018',
  },
  {
    id: 'onion',
    ...
    durationDays: 120,
    growthStages: [
      { name: 'Nursery', dayRange: [0, 35], keyActions: ['Raise seedlings on high bed'] },
      { name: 'Transplanting', dayRange: [35, 45], keyActions: ['Transplant seedlings 15x10cm', 'Apply basal fertilizer'] },
      { name: 'Bulb initiation', dayRange: [60, 85], keyActions: ['Irrigation', 'Top dress nitrogen carefully'] },
      { name: 'Bulb development', dayRange: [85, 110], keyActions: ['Stop irrigation before harvest', 'Monitor thrips'] },
      { name: 'Harvest', dayRange: [110, 120], keyActions: ['Harvest when tops fall', 'Cure bulbs in shade'] },
    ],
    waterNeedMm: 350,
    waterSourcePreference: ['tubewell', 'canal'],
    suitableSoils: ['loamy', 'silty', 'sandy'],
    rainfallTolerance: 'low',
    fertilizerKgPerAcre: { npk15_15_15: 85, urea: 75, tsp: 60, mop: 55, gypsum: 12 },
    typicalYieldPerAcre: { min: 120, max: 180, unit: 'maund' },
    typicalPricePerUnit: { min: 1200, max: 2600, unit: 'maund', currency: 'BDT' },
    majorPests: ['Thrips', 'Cutworm'],
    majorDiseases: ['Purple blotch', 'Stemphylium blight', 'Basal rot'],
    riskLevel: 'high',
    riskNotes: 'Price can be volatile; excess rain and poor curing reduce storage quality.',
    notes: 'High-value Rabi spice crop. Needs good drainage and careful curing after harvest.',
    source: 'BARI Spice Crop Manual (2022); BARC FRG 2018',
  },
  {
    id: 'groundnut',
    ...
    durationDays: 120,
    growthStages: [
      { name: 'Sowing', dayRange: [0, 7], keyActions: ['Seed treatment', 'Sow on well-drained sandy loam'] },
      { name: 'Vegetative', dayRange: [15, 40], keyActions: ['Weed control', 'Gypsum near pegging zone'] },
      { name: 'Pegging', dayRange: [40, 65], keyActions: ['Maintain loose soil', 'Light irrigation if dry'] },
      { name: 'Pod filling', dayRange: [65, 105], keyActions: ['Monitor leaf spot', 'Avoid waterlogging'] },
      { name: 'Harvest', dayRange: [105, 120], keyActions: ['Lift plants when pods mature', 'Dry pods well'] },
    ],
    waterNeedMm: 450,
    waterSourcePreference: ['rainfed', 'tubewell'],
    suitableSoils: ['sandy', 'loamy', 'silty'],
    rainfallTolerance: 'medium',
    fertilizerKgPerAcre: { npk15_15_15: 45, tsp: 40, mop: 25, gypsum: 35, boron: 1 },
    typicalYieldPerAcre: { min: 35, max: 55, unit: 'maund' },
    typicalPricePerUnit: { min: 2500, max: 3800, unit: 'maund', currency: 'BDT' },
    majorPests: ['Aphid', 'Termite', 'Leaf miner'],
    majorDiseases: ['Tikka leaf spot', 'Collar rot', 'Rust'],
    riskLevel: 'medium',
    riskNotes: 'Good for sandy land; harvest losses rise if soil is too wet or too hard.',
    notes: 'Useful oilseed-legume rotation crop for char and sandy loam areas.',
    source: 'BARI Oilseed Cultivation Guide (2022); BARC FRG 2018',
  },
];
...
export const INPUT_COSTS = {
  ureaPerKg: 27,            // govt-subsidized farmer-level price
  tspPerKg: 27,
  mopPerKg: 20,
  npk15PerKg: 32,
  gypsumPerKg: 12,
  ...
  seedLentilPerKg: 110,
  seedJutePerKg: 350,
  seedMungbeanPerKg: 140,
  seedSesamePerKg: 320,
  seedOkraPerKg: 900,
  seedCucumberPerKg: 1800,
  seedOnionPerKg: 1200,
  seedGroundnutPerKg: 120,
  seedTomatoPer10g: 80,
